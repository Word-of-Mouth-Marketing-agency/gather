...
export default function AdminDashboardPage() {
  ...
  const stats = [
    { label: 'Total Products', value: products.length, href: '/admin/products', color: 'bg-blue-50 text-blue-600' },
    { label: 'Categories', value: categories.length, href: '/admin/categories', color: 'bg-purple-50 text-purple-600' },
    { label: 'Featured', value: featuredProducts.length, href: '/admin/products', color: 'bg-[#fff4e8] text-[#ff7a1a]' },
    { label: 'Out of Stock', value: outOfStock.length, href: '/admin/products', color: 'bg-red-50 text-red-500' },
  ]
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-0.5">Gather admin overview</p>
      </div>
