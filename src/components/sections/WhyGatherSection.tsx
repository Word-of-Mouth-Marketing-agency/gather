...
const REASONS = [
  {
    ...
    description: 'Every product is carefully curated and selected from the finest suppliers.',
    icon: (
  ...
  },
  {
    ...
    description: 'Order before 4 PM and get your gifts delivered the same day across Cairo.',
    icon: (
      <svg className="w-8 h-8 text-[#ff7a1a]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      >
        {REASONS.map((reason) => (
          <div key={reason.title} data-reveal-item className="text-center">
            ...
            <h3 className="mt-4 font-bold text-[#171717]">{reason.title}</h3>
